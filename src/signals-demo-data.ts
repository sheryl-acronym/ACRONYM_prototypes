...
export const signalsData: Signal[] = [
  ...
  },
  {
    ...
    momentum: 'Strong',
    conversation_snippet:
      '"What platform do you support? We\'re currently on a custom built solution and wondering if we can integrate without rebuilding."',
    speaker_name: 'Rachel Green',
    llm_reasoning: 'Prospect asking about platform compatibility and integration capabilities.',
    transcript_url: 'https://example.com/transcript/signal-dq-002',
    meeting_date: '2026-02-11',
    meeting_time: '13:45',
    meeting_title: 'Platform compatibility discussion',
    timestamp: '00:12:30',
    response_speaker_name: 'Kevin Walsh',
    response_snippet: 'We support all major platforms—Shopify, WooCommerce, BigCommerce, and custom solutions. For custom builds, our REST API handles most integrations without rebuilding. We\'ve successfully integrated with platforms ranging from 1-year-old startups to legacy systems built 10 years ago.',
  ...
  },
  {
    ...
    momentum: 'Stalled',
    conversation_snippet:
      '"Your platform sounds good, but what are your technical requirements? Can we run it on our existing infrastructure?"',
    speaker_name: 'Brandon Scott',
    llm_reasoning: 'Prospect asking about technical architecture and infrastructure requirements.',
    transcript_url: 'https://example.com/transcript/signal-dq-003',
    meeting_date: '2026-02-09',
    meeting_time: '15:20',
    meeting_title: 'Technical architecture review',
    timestamp: '00:19:15',
    response_speaker_name: 'Patricia Moore',
    response_snippet: 'Our platform is entirely cloud-based through AWS, so you don\'t need to maintain any servers. It\'s accessible via API and browser, scales automatically with your traffic, and requires no special infrastructure on your end. We handle all maintenance and updates.',
