...
export const signalsData: Signal[] = [
  ...
  },
  {
    ...
    momentum: 'Active',
    conversation_snippet:
      '"How did you hear about us? We saw you mentioned in a podcast about HSA/FSA platforms."',
    speaker_name: 'Lisa Anderson',
    llm_reasoning: 'Prospect explaining how they discovered the company through podcast mention.',
    ...
    response_snippet: 'Yes, we were recently featured on the HealthTech Weekly podcast discussing HSA/FSA compliance. We\'ve been mentioned in several industry publications and our customers regularly refer new prospects. That\'s actually how many of our best partnerships start.',
  ...
  },
  {
    ...
    momentum: 'Strong',
    conversation_snippet:
      '"We\'re on Shopify currently. Are you integrated with Shopify, or would we need to build a custom integration?"',
    speaker_name: 'Rachel Green',
    llm_reasoning: 'Prospect asking about e-commerce platform support and integration requirements.',
    transcript_url: 'https://example.com/transcript/signal-dq-002',
    meeting_date: '2026-02-11',
    meeting_time: '13:45',
    meeting_title: 'Platform and checkout discussion',
    timestamp: '00:12:30',
    response_speaker_name: 'Kevin Walsh',
    response_snippet: 'Yes, we have a native Shopify integration. It\'s a simple plugin install from the Shopify App Store, no custom development needed. Most of our customers use either Shopify or WooCommerce, which both have native integrations.',
  ...
  },
  {
    ...
    momentum: 'Strong',
    conversation_snippet:
      '"So what\'s the typical order value for HSA/FSA purchases? We average around $150 per transaction, is that enough to make sense for your solution?"',
    speaker_name: 'Brandon Scott',
    llm_reasoning: 'Prospect asking about transaction size and whether their order value is suitable for the solution.',
    transcript_url: 'https://example.com/transcript/signal-dq-003',
    meeting_date: '2026-02-09',
    meeting_time: '15:20',
    meeting_title: 'Pricing and transaction size discussion',
    timestamp: '00:19:15',
    response_speaker_name: 'Patricia Moore',
    response_snippet: 'That\'s a great order value. Our solution works well across the range - we support everything from $50 to $5000+ transactions. At $150 average, your volume makes strong economic sense. We\'ve found that higher order values actually benefit more from our HSA/FSA verification tools because there\'s more transaction value to protect.',
