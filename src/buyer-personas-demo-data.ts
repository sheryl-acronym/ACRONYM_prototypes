...
export const buyerPersonasData: BuyerPersona[] = [
  ...
  },
  {
    ...
    typically_found_in: ['Enterprise Multi-Channel Advanced Operations', 'Health Tech Growth-Stage Partnership-Ready', 'Mid-Market E-Commerce Growth Brands', 'Mid-Market Multi-Channel Operators', 'SMB DTC Health/Wellness Fast-Movers'],
  },
  {
    id: 'bp-003',
    category: 'Secondary',
    ...
    typically_found_in: ['Mid-Market E-Commerce Growth Brands', 'Mid-Market Multi-Channel Operators'],
  },
  {
    id: 'bp-004',
    category: 'Emerging',
