...
import { MoreVertical, Plus, Loader2, ArrowRight } from 'lucide-react';
...
import { initialOrgSlackSettings } from '@/settings-mock-data';

type MessagingProvider = 'slack' | null;

export default function OrgSlackPage() {
  const [connected, setConnected] = React.useState<MessagingProvider>('slack');
  ...
  const settings = initialOrgSlackSettings;
  ...
  return (
    <div className="max-w-2xl">
      ...
      <p className="text-sm text-neutral-500 mb-8">
        Connect your Slack workspace to enable org-wide channel notifications and alerts.
      </p>
      ...
      {connected ? (
              ...
              <div>
                ...
                <div className="flex items-center gap-1.5 mt-0.5">
                  ...
                  <span className="text-sm text-neutral-500">
                    {settings.workspace_name} workspace · Connected by Alex Chen
                  </span>
                </div>
              </div>
            </div>
        ...
        <div className="flex items-start justify-between p-5 rounded-lg border-2 border-neutral-200 bg-white">
          ...
          <Button variant="outline" size="sm" onClick={() => setConnected('slack')} className="gap-1.5">
        ...
        <DialogContent className="max-w-sm">
          <DialogHeader>
            ...
            <DialogDescription className="pt-1 text-neutral-500 space-y-2">
              <span className="block">This will immediately disconnect your Slack workspace from ACRONYM.</span>
              <span className="block">All channel notifications and workflow alerts will stop. You can reconnect at any time.</span>
            </DialogDescription>
          </DialogHeader>
