...
export const customerProfilesData: CustomerProfile[] = [
  {
    ...
    example_companies: ['better being co.', 'arbonne', 'bauerfeind usa', 'lululemon', 'peloton', 'birkenstock'],
  },
  {
    id: 'cp-002',
    category: 'Secondary',
    ...
    example_companies: ['allermi', 'brainhq from posit science', 'cal ai', 'omada health', 'livongo', 'ginger'],
  },
  {
    id: 'cp-003',
    category: 'Ideal',
    ...
    example_companies: ['elemind technologies, inc.', 'basic research', 'chilipad by sleepme', 'theragun', 'oura ring', 'whoop', 'lumin health', 'vitality co.', 'zenith wellness'],
  },
  {
    id: 'cp-004',
    category: 'Secondary',
    ...
    example_companies: ['balanced body', 'bathhouse', 'bells of steel', 'gymboss', 'fitbit premium', 'apple watch'],
  },
  {
    id: 'cp-005',
    category: 'Ideal',
    ...
    example_companies: ['adaptive sound technologies, inc.', 'adco medical suppliers', 'aletha health', 'blue light special', 'recover athletics', 'pliability'],
  },
];
