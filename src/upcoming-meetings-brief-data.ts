    ...
    return {
      ...
      metadata: {
        ...
        meddic_completion: {
          ...
          partial: 2,
          missing: 3,
          gaps: ['Competition not yet explored', 'Compelling event timing unclear'],
        },
        meddic_detail: [
          { name: 'Metrics', status: 'complete', information: '$35M+ ARR, 95% product eligibility' },
          { name: 'Economic Buyer', status: 'complete', information: 'Russell Harris (Head of Product)' },
          { name: 'Decision Process', status: 'partial', information: 'Involves Yuliia (QA) and Theresa (Brand)' },
          { name: 'Decision Criteria', status: 'partial', information: 'Unit economics, brand alignment unclear' },
          { name: 'Decision Maker', status: 'complete', information: 'Russell is primary champion' },
          { name: 'Identify Pain', status: 'complete', information: 'AOV stagnation, margin pressure' },
          { name: 'Champion', status: 'complete', information: 'Russell is self-advocating' },
          { name: 'Competition', status: 'missing', information: 'Not yet explored' },
          { name: 'Compelling Event', status: 'missing', information: 'Profitability pivot drives urgency' },
        ],
      },
      brief: {
        ...base.brief,
